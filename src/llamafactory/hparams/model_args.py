...
class ProcessorArguments:
    ...
    max_pixel: int = field(
        default=None,
        metadata={"help": "Keeps the maximum pixel of image below this number, should be an int."},
    )
    ...
    grayscale_prob: float = field(
        default=0.0,
        metadata={"help": "Probability of converting an image to grayscale, must be between 0 and 1."},
    )
    blur_prob: float = field(
        default=0.0,
        metadata={"help": "Probability of applying a blur effect to the image, must be between 0 and 1."},
    )
    max_blur_radius: float = field(
        default=5.0,
        metadata={"help": "Maximum radius for the blur effect, must be a positive number."},
    )
    brightness_prob: float = field(
        default=0.0,
        metadata={"help": "Probability of adjusting image brightness, must be between 0 and 1."},
    )
    brightness_delta: float = field(
        default=0.2,
        metadata={"help": "Range of brightness adjustment, must be a value between 0 and 1."},
    )
    random_resize_max_pixel: int = field(
        default=None,
        metadata={"help": "Maximum pixel for random resizing."},
    )
    random_resize_min_pixel: float = field(
        default=None,
        metadata={"help": "Minimum pixel for random resizing."},
    )
    do_jpeg_compression: bool = field(
        default=False,
        metadata={"help": "Whether to apply JPEG compression to the image."},
    )
    max_quality: int = field(
        default=100,
        metadata={"help": "Maximum quality for JPEG compression, must be an integer between 1 and 100."},
    )
    min_quality: int = field(
        default=75,
        metadata={"help": "Minimum quality for JPEG compression, must be an integer between 1 and 100."},
    )
