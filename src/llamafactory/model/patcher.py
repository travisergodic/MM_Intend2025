...
def patch_processor(
    ...
    setattr(processor, "max_pixel", model_args.max_pixel)
    # random graysscale
    setattr(processor, "grayscale_prob", model_args.grayscale_prob)
    # random brightness
    setattr(processor, "brightness_prob", model_args.brightness_prob)
    setattr(processor, "brightness_delta", model_args.brightness_delta)
    # random blur
    setattr(processor, "blur_prob", model_args.blur_prob)
    setattr(processor, "max_blur_radius", model_args.max_blur_radius)
    # random resize
    setattr(processor, "random_resize_max_pixel", model_args.random_resize_max_pixel)
    setattr(processor, "random_resize_min_pixel", model_args.random_resize_min_pixel)
    # jpeg compression
    setattr(processor, "do_jpeg_compression", model_args.do_jpeg_compression)
    setattr(processor, "max_quality", model_args.max_quality)
    setattr(processor, "min_quality", model_args.min_quality)
